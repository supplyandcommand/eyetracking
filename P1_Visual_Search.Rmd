...
star_paths("2019-3_1_f11", "flower.jpg")
...
AOI = c(478, 502, 367, 392)

test <- Fixations_VS_2 %>%
  filter(ParticipantID == "2019-6_3_f22" &
           Item == "penguins.jpg")

ggplot(test, aes(x = PositionX, y = PositionY, color = ParticipantID, size = Duration)) +
...
# DOESN'T WORK, AOIS ARE FUCKED
a <- Fixations_VS_2 %>%
  mutate(peng_star_aoi = ifelse(PositionX > 478+20 &
                                   PositionX < 502+20 &
                                   PositionY > 367+20 &
                                   PositionY < 392+20, 1, 0),
