...
Merging logfiles and Fixations. 
...
#predicting condition based on pupil size & StartTime from fixations. 



Model1 <- glmer(Pupilsize ~ Ostension * Directedness + Starttime +
            (1 + gender_stim | ParticipantID) + 
            (1 + Ostension * Directedness | ID, data = ??)

Model2 <- glmer(Saccade velocity ~ Ostension * Directedness + Starttime +
            (1 + gender_stim | ParticipantID) + 
            (1 + Ostension * Directedness | ID, data = ??)
