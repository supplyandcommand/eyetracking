...
#However, do we actually want StartTime as a fixed effect?
#I guess that we might want StartTime as fixed because that is what it varies with. 
Model1 <- glmer(PupilSize ~ ost * direct + 
...
#Model interaction
Model2 <- glmer(MeanVelocity ~ ost * direct +
            (1 + stim_person | ParticipantID) + 
            (1 + ost * direct | ParticipantID) +
