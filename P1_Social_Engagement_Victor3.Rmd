...
p1 <- ggplot(Fixations_SE, aes(Duration, fill = ParticipantID)) + geom_density(alpha = 0.3) #super long tails - power-law. 
p1
...
p3 <- ggplot(Fixations_SE, aes(PupilSize, fill = "blue")) + geom_density(alpha = 0.3) 
p3
#bi-modal 

## Check distribution of saccade velocity, power-law (also log-link)
p4 <- ggplot(Saccades_SE, aes(MeanVelocity, fill = "blue")) + geom_density()
p4
...
p8 <- ggplot(Fixations_SE, aes(x = StartTime, y = Duration, color = ParticipantID)) +
